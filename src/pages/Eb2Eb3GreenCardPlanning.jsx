...
export default function Eb2Eb3GreenCardPlanning() {
  return (
    <PageLayout>
      <Seo
        title="EB Pathway Program — 搭建雇主体系，积累职业移民申请材料"
        description="Keystone的 EB Pathway Program，帮助国际专业人才搭建推进EB-2/EB-3职业类绿卡路径所需的雇主架构、职位体系与运营记录。"
      ...
      <CompactCta
        title="咨询 EB 申请规划"
        description={<p>公司注册、雇主搭建、PWD/PERM协调与I-140 申请准备，串联成一条结构化的路径。</p>}
        ctaLabel="咨询 EB 申请规划"
      />
      <CaseStudies />
      <WhyKeystone />
      ...
      <CompactCta
        ...
        description={
          <p>
            ...
            以及一路积累下来的各项记录。EB Pathway Program，将这些环节整合进一条结构化的路径。
          </p>
        }
        ctaLabel="预约免费EB路径评估"
      />
