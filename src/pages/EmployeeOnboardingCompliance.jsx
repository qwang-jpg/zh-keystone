...
export default function EmployeeOnboardingCompliance() {
  return (
    <PageLayout>
      <Seo
        title="招聘与入职体系"
        description="Keystone Strategies 为每一位新员工搭建标准化的招聘流程与合规入职体系，从offer审批到I-9与W-4 表格填写，并配套美国基础雇佣合规指南。"
      ...
      <CompactCta
        ...
        description={<p>可复用的招聘流程、聘用信、I-9、W-4，以及背后的合规保障，全部在入职首日之前准备就绪。</p>}
        ctaLabel="预约入职体系咨询"
      />
    </PageLayout>
  );
