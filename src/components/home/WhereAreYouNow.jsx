...
const goals = [
  {
    ...
    badgeLabel: "建议启动时间",
    badgeValue: "提前2个月",
    secondaryBadgeLabel: "我们的办理周期",
    secondaryBadgeValue: "2周",
    heading: "让您的OPT持续有效、身份合规",
    body: "我们通过500多家合作与孵化企业组成的网络，帮助OPT持有者找到真实、合规的工作机会，并指导完成所有必要的申报材料，确保您在失业计时期内保持合法就业。我们建议在需要之前约两个月启动，团队通常需要两周即可帮客户完成全部准备。",
    cta: "预约OPT免费咨询",
  },
  {
    label: "维持STEM OPT身份",
    ...
    body: "我们协助您与雇主共同设计I-983培训计划，准备I-765延期申请，并全程跟踪案件直至补件通知（RFE）或最终评估完成，同时确保真实的雇主合规——包括岗位职责、监督安排与雇佣关系都经得起审查。我们建议在延期窗口开放前约两个月启动，团队通常需要四周完成整个流程。",
    cta: "预约STEM OPT免费咨询",
  },
  {
    label: "首次申请H-1B",
    ...
    body: "通过H-1B无限续航计划，我们负责公司注册、EIN申请、治理文件、E-Verify以及各项运营要求，让您合法创立企业，并获得每年参与H-1B抽签的无限资格，无需雇主担保。我们建议提前约三个月启动，团队通常需要六到八周为客户完成全部准备工作。",
    cta: "预约H-1B申请免费咨询",
  },
  {
    label: "转移H-1B",
