...
const pillars = [
  {
    ...
    description:
      "我们以结果为导向，而非一次性交付。在适用情况下，我们的服务承诺与保障机制会在服务协议中明确列明，随着客户的雇佣与身份需求变化，在首次合作后继续提供支持。",
    facts: [
  ...
  },
  {
    ...
    num: "02",
    title: "开创性的雇主架构模式",
    meta: "雇主搭建 · 运营 · 雇佣 · 身份申请准备",
    panelTitle: "搭建支撑移民需求的雇主架构",
    description:
      "Keystone率先打造了融合公司注册、企业运营、薪资管理、劳工合规与移民申请准备的一体化模式。我们不将移民与雇佣视为两个独立问题，而是从根基出发，搭建能够同时支撑二者的雇主架构。",
    facts: [
      { value: "1套模式", label: "一体化雇主架构" },
      { value: "4重架构", label: "商业 · 运营 · 雇佣 · 身份" },
      { value: "全流程覆盖", label: "从公司注册到雇主申请准备" },
    ],
  },
  {
    icon: Award,
    num: "03",
    title: "H-1B 与 STEM OPT 成功率 100%",
    meta: "执行力 · H-1B · STEM OPT · OPT",
    panelTitle: "以真实客户成果验证实力",
    description:
      "我们的H-1B与OPT/STEM OPT解决方案，均建立在已被真实客户案例反复验证的路径之上。从雇主准备、雇佣架构设计到持续的合规支持，我们的方法始终围绕实际执行，而非纸上谈兵。",
    facts: [
