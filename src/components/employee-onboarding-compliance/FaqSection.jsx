...
export const faqs = [
  {
    ...
    answer:
      "第一部分必须在员工入职首日前完成，第二部分则必须由雇主在入职日期后三个工作日内完成。我们会帮您搭建一套流程，确保每一次都能踩准这个时间窗口。",
  },
  {
    question: "STEM OPT或H-1B员工的入职要求是否有所不同？",
    answer:
      "核心的联邦表格（I-9、W-4）对每位员工都是一样的，但STEM OPT与H-1B员工还需要额外的文件支持，例如与签证申请材料相符的真实offer信与职位描述。我们会根据这些要求定制入职流程。",
  },
  {
